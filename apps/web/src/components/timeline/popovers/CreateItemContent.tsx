...
interface CreateItemContentProps {
    onAddItem: (title: string, date: number, projectId: string, subProjectId?: string, color?: number) => void;
    onAddMilestone: (projectId: string, title: string, date: number, color?: number) => void;
    onAddSubProject: (projectId: string, title: string, startDate: number, endDate: number, color?: number) => void;
    ...
    const handleSubmit = () => {
        ...
        for (let i = 0; i < count; i++) {
            ...
            if (type === 'item') {
                ...
                onAddMilestone(selectedProjectId, title, dateMs, color);
